...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView runat="server" ID="gvEmpresas" CssClass="page7" AutoGenerateColumns="False" onrowcommand="gvEmpresas_RowCommand"
    ...
    <div align="right">
        <asp:Button runat="server" ID="btnNuevaEmpresa" Text="Nueva Empresa" onclick="btnNuevaEmpresa_Click" class="btn btn-primary" Visible="False" />
    </div>
</asp:Content>
